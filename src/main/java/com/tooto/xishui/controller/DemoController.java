...
import com.tooto.xishui.vo.ResObject;
...
public class DemoController {
    ...
    public ResObject createUser(@RequestBody UserInfo user) {
    ...
    public ResObject updateUser(@RequestBody UserInfo user) {
    ...
    public UserInfo queryUser(@RequestParam("userId") String userId) {
        System.out.println("queryUser:::" + userId);
        UserInfo user = new UserInfo(userId, "张三", "******", "mao2080@sina.com");
        return user;
    }
